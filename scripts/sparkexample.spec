...
$mvn_install_cmd -Dfile=/opt/%{parent_rpm_pkg_name}-%{_spark_version}/assembly/target/scala-2.10/spark-assembly-%{_spark_version}-hadoop%{_hadoop_version}.jar -DartifactId=spark-assembly_2.10 $mvn_install_target_repo

# For Kafka Spark Streaming Examples
$mvn_install_cmd -Dfile=/opt/%{parent_rpm_pkg_name}-%{_spark_version}/external/kafka/target/spark-streaming-kafka_2.10-%{_spark_version}.jar -DartifactId=spark-streaming-kafka_2.10 $mvn_install_target_repo

$mvn_install_cmd -Dfile=/opt/%{parent_rpm_pkg_name}-%{_spark_version}/streaming/target/spark-streaming_2.10-%{_spark_version}.jar -DartifactId=spark-streaming_2.10 $mvn_install_target_repo
...
$mvn_install_cmd -Dfile=/opt/%{parent_rpm_pkg_name}-%{_spark_version}/sql/hive/target/spark-hive_2.10-%{_spark_version}.jar -DartifactId=spark-hive_2.10 $mvn_install_target_repo
